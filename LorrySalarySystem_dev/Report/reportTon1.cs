...
{
    public partial class reportTon1 : DevExpress.XtraReports.UI.XtraReport
    {
        ...
        public reportTon1()
        {
            ...
            //this.DataSourceDemanded += reportTon1_DataSourceDemanded;
            //string strQuery = ((CustomSqlQuery)sqlDataSource1.Queries[0]).Sql;
            //oriQuery.Sql = strQuery;
        }

        private void reportTon1_DataSourceDemanded(object sender, EventArgs e)
        {
